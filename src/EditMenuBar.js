...
export const EditMenuBar = () => {
  return (
    <>
      <div class="dashboard-header css-1qf0uii" data-test-id="3">
        <div class="dashboard-component-header header-large">
          <span class="editable-title">
            <span title="[ untitled dashboard ]">新規業務フロー</span>
          </span>
          <span class="ant-tag css-15voufr">Draft</span>
          <a href="#" class="fave-unfave-icon css-1nnaep8" role="button">
            <span
              role="img"
              aria-label="favorite-unselected"
              class="anticon css-sup2qv"
            >
              <svg
                width="1em"
                height="1em"
        ...
        <div class="button-container">
          ...
          <span
            ...
            class="action-button"
          >
            <span role="img" aria-label="edit-alt" class="anticon css-tp6bb2">
              <svg
                width="1em"
                height="1em"
                viewBox="0 0 24 24"
              ...
              >
                <path
                  fill-rule="evenodd"
                  clip-rule="evenodd"
                  d="M5 18.5058H9.24C9.5058 18.5073 9.76128 18.403 9.95 18.2158L16.87 11.2858L19.71 8.5058C19.8993 8.31803 20.0058 8.06244 20.0058 7.7958C20.0058 7.52916 19.8993 7.27356 19.71 7.0858L15.47 2.7958C15.2822 2.60649 15.0266 2.5 14.76 2.5C14.4934 2.5 14.2378 2.60649 14.05 2.7958L11.23 5.6258L4.29 12.5558C4.10281 12.7445 3.99846 13 4 13.2658V17.5058C4 18.0581 4.44772 18.5058 5 18.5058ZM14.76 4.9158L17.59 7.7458L16.17 9.1658L13.34 6.3358L14.76 4.9158ZM6 13.6758L11.93 7.7458L14.76 10.5758L8.83 16.5058H6V13.6758ZM21 20.5058H3C2.44772 20.5058 2 20.9535 2 21.5058C2 22.0581 2.44772 22.5058 3 22.5058H21C21.5523 22.5058 22 22.0581 22 21.5058C22 20.9535 21.5523 20.5058 21 20.5058Z"
                  fill="currentColor"
                ></path>
              </svg>
            </span>
          ...
          <div
            ...
            role="button"
            class="ant-dropdown-trigger css-1af8uep"
          >
            <span role="img" aria-label="more-horiz" class="anticon css-tp6bb2">
              <svg
                width="1em"
                height="1em"
                viewBox="0 0 24 24"
